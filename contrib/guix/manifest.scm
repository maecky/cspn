...
(define* (make-cspn-cross-toolchain target
                                  #:key
...
desirable for building CSPN Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-cspn-cross-toolchain "i686-linux-gnu")
       (make-cspn-cross-toolchain "x86_64-linux-gnu")
       (make-cspn-cross-toolchain "aarch64-linux-gnu")
       (make-cspn-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-cspn-cross-toolchain "riscv64-linux-gnu"
