# Bootstrappable CSPN Core Builds

This directory contains the files necessary to perform bootstrappable CSPN
Core builds.
...
- 24GB of free disk space on the partition that the CSPN Core git repository
  resides in
...
For a CSPN Core depends development environment, simply invoke
...
From the top of a clean CSPN Core repository:
...
To use dongcarl's substitute server for CSPN Core builds after having
