...
#ifndef CSPN_SCRIPT_STANDARD_H
#define CSPN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cspn address
 */
...
/**
 * Generate a CSPN scriptPubKey for the given CTxDestination. Returns a P2PKH
