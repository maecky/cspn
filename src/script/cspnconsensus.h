...
#ifndef CSPN_SCRIPT_CSPNCONSENSUS_H
#define CSPN_SCRIPT_CSPNCONSENSUS_H
...
#include <config/cspn-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBCSPNCONSENSUS)
...
#define CSPNCONSENSUS_API_VER 1
...
#endif // CSPN_SCRIPT_CSPNCONSENSUS_H
