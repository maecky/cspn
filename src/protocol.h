...
#ifndef CSPN_PROTOCOL_H
#define CSPN_PROTOCOL_H
...
/**
 * CSPN protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // CSPN Core does not support this but a patch set called CSPN XT does.
    ...
    // cspn-development mailing list. Remember that service bits are just
